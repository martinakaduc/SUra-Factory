...
_DESCRIPTION = "WikiLingua Dataset for DPO"
_CITATION = ""
_HOMEPAGE = "https://huggingface.co/datasets/ura-hcmut/wiki_lingua-dpo"
_LICENSE = "mit"
...
class WikiLinguaDPO(datasets.GeneratorBasedBuilder):
